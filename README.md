...
The packages in the `turtlebot3_simulations` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy turtlebot3_simulations --override-release-repository-push-url git@github.com:revyos-ros/turtlebot3_simulations-release.git` on `Fri, 13 Jun 2025 03:48:58 -0000`
...
- release repository: https://github.com/revyos-ros/turtlebot3_simulations-release.git
...
The packages in the `turtlebot3_simulations` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy turtlebot3_simulations --override-release-repository-push-url git@github.com:revyos-ros/turtlebot3_simulations-release.git --edit` on `Mon, 07 Apr 2025 04:43:03 -0000`
